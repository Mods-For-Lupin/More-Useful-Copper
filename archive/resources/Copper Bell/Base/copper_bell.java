...
public class Copper Bell - Converted<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "copper_bell - converted"), "main");
	private final ModelPart body;
	private final ModelPart base;

	public Copper Bell - Converted(ModelPart root) {
