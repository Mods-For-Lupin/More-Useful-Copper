...
public class Oxidized Copper Bell<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "oxidized_copper bell"), "main");
	private final ModelPart body;
	private final ModelPart base;

	public Oxidized Copper Bell(ModelPart root) {
